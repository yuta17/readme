<template>
  <Layout>
    ...
    <article>
      ...
      <br>
      <p>仕事・個人問わず、「自分が欲しくて使うものを作る」ことを大切にしています。</p>

      <section>
        <h2 class="section-title">ピアノを弾きます</h2>
